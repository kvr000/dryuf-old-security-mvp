...
public class CommonLogoutPresenter extends LogoutPresenter
{
	public				CommonLogoutPresenter(net.dryuf.mvp.Presenter parentPresenter, net.dryuf.core.Options options)
	{
	...
	{
		authenticationFrontend.logout(getPageContext());
		getCallerContext().loggedOut();
		return true;
	}
